...
void Seg_Proc()
{
	...
	case 0:
		...
		{
			Seg_Buf[3] = (Freq_CAL / 10000 % 10 == 0) ? 10
													  : Freq_CAL / 10000 % 10;
			Seg_Buf[4] = (Seg_Buf[3] == 10 && Freq_CAL / 1000 % 10 == 0) ? 10
																		 : Freq_CAL / 1000 % 10;
			Seg_Buf[5] = (Seg_Buf[4] == 10 && Freq_CAL / 100 % 10 == 0) ? 10
																		: Freq_CAL / 100 % 10;
			Seg_Buf[6] = (Seg_Buf[5] == 10 && Freq_CAL / 10 % 10 == 0) ? 10
																	   : Freq_CAL / 10 % 10;
	...
	case 3:
		...
		case 0:
			...
			Seg_Buf[1] = 11; // F
			Seg_Buf[2] = 10;
			Seg_Buf[3] = (Freq_MAX / 10000 % 10 == 0) ? 10
													  : Freq_MAX / 10000 % 10;
			Seg_Buf[4] = (Seg_Buf[3] == 10 && Freq_MAX / 1000 % 10 == 0) ? 10
																		 : Freq_MAX / 1000 % 10;
			Seg_Buf[5] = (Seg_Buf[4] == 10 && Freq_MAX / 100 % 10 == 0) ? 10
																		: Freq_MAX / 100 % 10;
			Seg_Buf[6] = (Seg_Buf[5] == 10 && Freq_MAX / 10 % 10 == 0) ? 10
																	   : Freq_MAX / 10 % 10;
